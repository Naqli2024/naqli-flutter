...
class RequestSupport extends StatefulWidget {
  ...
  final String email;
  const RequestSupport({super.key, required this.firstName, required this.token, required this.partnerId, required this.email});
                    ...
                    GestureDetector(
                        onTap: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => SubmitTicket(firstName: widget.firstName, token: widget.token, partnerId: widget.partnerId, email: widget.email)
                            ),
                          );
                        },
                  ...
                  child: Padding(
                    ...
                    child: Text('Enter your Email address'.tr(),
                      style: TextStyle(
                        ...
                        fontSize: viewUtil.isTablet?25:23,
                      ),),
                  ),
                ),
                Padding(
                        ...
                        if(widget.email.isNotEmpty && descriptionController.text.isNotEmpty)
                          {
                            ...
                            await _authService.submitTicket(
                                context,
