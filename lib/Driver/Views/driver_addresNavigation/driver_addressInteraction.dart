...
class DriverAddressInteraction extends StatefulWidget {
  ...
  const DriverAddressInteraction({super.key, required this.firstName, required this.lastName, required this.token, required this.id, required this.bookingId, required this.pickUp, required this.quotePrice, required this.userId, required this.partnerId, required this.address});
...
class _DriverAddressInteractionState extends State<DriverAddressInteraction> {
  ...
  final double minDistanceForRouteUpdate = 50.0;
  final Duration minTimeBetweenUpdates = Duration(seconds: 10);
